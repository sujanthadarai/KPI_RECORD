"""
Django settings for staff_schedule_backend project.
...
SECRET_KEY = 'django-insecure-wj#c=%@&x_$&y4_85gs38g*pn9($ivpbga=&^clsf=(o&q!ah0'
...
ROOT_URLCONF = 'staff_schedule_backend.urls'
...
WSGI_APPLICATION = 'staff_schedule_backend.wsgi.application'
